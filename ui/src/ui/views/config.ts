...
function getSections(): Array<{ key: string; label: string }> {
  return [
    { key: "env", label: t("config.environment") },
    { key: "update", label: t("config.updates") },
    { key: "agents", label: t("config.agents.title") },
    { key: "auth", label: t("config.authentication") },
    { key: "channels", label: t("channels.title") },
    { key: "messages", label: t("config.messagesLabel") },
    { key: "commands", label: t("config.commands") },
    { key: "hooks", label: t("config.hooks") },
    { key: "skills", label: t("skills.title") },
    { key: "tools", label: "Tools" },
    { key: "gateway", label: t("config.gateway.title") },
    { key: "wizard", label: t("config.setupWizard") },
  ];
}
      ...
      <main class="config-main">
        ...
        <div class="config-actions">
                  ...
                  <span class="config-changes-badge"
                    >${
                      props.formMode === "raw"
                        ...
                        : diff.length !== 1
                          ? t("config.unsavedChangesCount", { count: String(diff.length) })
          ...
          <div class="config-actions__right">
            ...
            >
              ${props.loading ? t("common.loadingShort") : t("common.reload")}
            </button>
            <button
            ...
            ? html`
              <details class="config-diff">
                <summary class="config-diff__summary">
                  <span
                    >${diff.length !== 1 ? t("config.viewPendingChangesPlural", { count: String(diff.length) }) : t("config.viewPendingChanges", { count: String(diff.length) })}</span
                  >
                  <svg
